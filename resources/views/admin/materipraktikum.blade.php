...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
                <h4><center> Materi Praktikum </center></h4>
        </div>
    </div>
    ...
    <div class="row mt-4">
        <div class="col-lg-3">
            <button type="button" class="btn btn-outline-primary">Tambah Materi Praktikum</button>
        </div>
                ...
                <table class="table table-hover table-bordered ">
                  <thead>
                    <tr  class="table-primary table-active" align="center">
                      ...
                      <th scope="col" width="10%">Praktikum</th>
                      <th scope="col">Kode Praktikum</th>
                      <th scope="col">Materi</th>
                      <th scope="col">Link Silabus & Materi</th>
                  ...
                  <tbody id="isi">
                    <tr>
                      ...
                      <td>PBW</td>
                      <td>PHP</td>
                      <td>https://drive.google.com/open?id=1YyUDVMG7aWUEC3xLI87L9xMODFsX3SgS</td>
                      <td align="center">
                          <span>
