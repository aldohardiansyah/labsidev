                  ...
                  <div class="card-body">
                      ...
                      <form method="POST" action="{{ route('admin_jadwalpraktikum.insert') }}" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group row"><!--Separator Busway-->
                                <div class="col-sm-1"></div>
                                <label for="staticEmail" class="col-sm-2 col-form-label"><strong>Asisten 3</strong></label>
                                <div class="col-sm-8">
                                    <select class="form-control selectdua select" name="asisten3" id="nama_asisten">
                                        <option value="" disabled selected>Pilih Asisten</option>
                            ...
                            <div class="form-group row"><!--Separator Busway-->
                                <div class="col-sm-1"></div>
                                <label for="staticEmail" class="col-sm-2 col-form-label"><strong>Asisten 4</strong></label>
                                <div class="col-sm-8">
                                    <select class="form-control selectdua select" name="asisten4">
                                        <option value="" disabled selected>Pilih Asisten</option>
                                    @foreach ($dataasisten as $dataasisten5)
                            ...
                            <div class="form-group row"><!--Separator Busway-->
                                <div class="col-sm-1"></div>
                                <label for="staticEmail" class="col-sm-2 col-form-label"><strong>Asisten 5</strong></label>
                                <div class="col-sm-8">
                                    <select class="form-control selectdua select" name="asisten5" id="nama_asisten">
                                        <option value="" disabled selected>Pilih Asisten</option>
                                    @foreach ($dataasisten as $dataasisten6)
